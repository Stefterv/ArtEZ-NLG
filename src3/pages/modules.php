...
<main>
	<div class="container">
		<div class="properties">
			...
			?>
			<? foreach($tags as $tag): ?>
			<div class="tag" data-pagetype="modules"><?=htmlentities($tag->title)?></div>
			<? endforeach; ?>
		</div>
		<div class="navigation module_overview">
			...
			<div class="document_container">
				...
				?>
				<div class="module_item <?=$tagString?>" data-id=<?=$module->id;?> data-title="<?=htmlentities($module->title);?>">
					<div class="module_selection">&nbsp;</div>
					<div class="module_title"><?=htmlentities($module->title);?></div>
